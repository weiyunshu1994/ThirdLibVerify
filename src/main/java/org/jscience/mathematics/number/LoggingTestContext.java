...
public class LoggingTestContext extends TestContext {
     ...
     * @see TestContext#doTest(TestCase)
     */
    @Override
     ...
     * @see TestContext#doAssertEquals(String, Object, Object)
     */
    @Override
     ...
     * @see javolution.context.LogContext#logInfo(CharSequence)
     */
    @Override
    ...
    /**
     * Logs to {@link System#out}.
     * @see javolution.context.LogContext#logWarning(CharSequence)
     */
    @Override
    ...
    /**
     * Logs to {@link System#out}.
     * @see javolution.context.LogContext#logError(Throwable, CharSequence)
     */
    @Override
